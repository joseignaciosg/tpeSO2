...
; mt_chain -- Llama a un vector de interrupcion de software con un juego de 
;		      registros.
;
;		   void mt_chain(SoftIntHandler_t handler, InterruptRegs_t *regs);
;
...
CHAIN_STACK struc			; Estructura del stack frame de la
							; funcion chain.
	saved_bp	dw ?		;
	saved_si	dw ?		;
	saved_di	dw ?		;
