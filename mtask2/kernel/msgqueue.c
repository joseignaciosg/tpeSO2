...
static bool
get_msg(MsgQueue_t *mq, void *msg, Time_t msecs)
{
...
static bool
put_msg(MsgQueue_t *mq, void *msg, Time_t msecs)
{
...
bool
GetMsgQueueTimed(MsgQueue_t *mq, void *msg, Time_t msecs)
{
	bool result;
...
bool
PutMsgQueueTimed(MsgQueue_t *mq, void *msg, Time_t msecs)
{
	bool result;
