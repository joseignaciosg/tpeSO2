...
bool			
EnterMonitorTimed(Monitor_t *mon, Time_t msecs)
{
...
/*
--------------------------------------------------------------------------------
WaitCondition, WaitConditionCond, WaitConditionTimed - esperar una condicion
...
bool				
WaitConditionTimed(Condition_t *cond, Time_t msecs)
{
	bool success;
